<footer class="footer">
            <div class="first_footer">
                <div class="first_left">
                    <div class="first_left_block1">
                        ...
                        <div class="messendger">
                            <div class="messendger_bl1"><img src="./image/facbook1.png" alt="facbook"></div>
                            <div class="messendger_bl2"><img src="./image/twiter1.png" alt="twiter"></div>
                            <div class="messendger_bl3"><img src="./image/viber1.png" alt="viber"></div>
                            <div class="messendger_bl4"><img src="./image/telegram1.png" alt="telegram"></div>
                        </div>
                    </div>
                    <div class="first_left_block2">
                        <div class="first_name1">Quick Links</div>
                        <ul>
                            <li>Buy a property</li>
                            <li>Sell a property</li>
                            <li>Rent a property</li>
                            <li>Сalculate your property</li>
                            <li>Top offers</li>
                            <li>Top cities</li>
                        </ul>
                    </div>
                    <div class="first_left_block3">
                        <div class="first_name2">About</div>
                        <ul>
                            <li>About Us</li>
                            <li>Our agents</li>
                            <li>Help & support</li>
                ...
                <div class="first_right">
                    <div class="first_name3">Recent Posts</div>
                    <div class="first_right_block1">
                        <div class="first_right_block1_image">
                            <img src="./image/th01.jpg" alt="th01">
                        </div>
                        <div class="first_right_block1_text">
                            <div class="first_right_block1_text_top">HOME IMPROVEMENT</div>
                            <div class="first_right_block1_text_name">Your Guide to a Smart Apartment Searching</div>
                            <div class="first_right_block1_text_desc">Mi justo, varius vitae cursus ipsum sem massa amet
                                pellentesque. Ipsum enim sit nulla ridiculus semper nam...</div>
                            <div class="first_right_block1_text_bottom">
                                <div class="first_right_block1_text_bottom1">
                                    <i class="fi-calendar mt-n1 me-1 fs-sm align-middle opacity-70"></i>
                                    Dec 4
                                </div>
                                <div class="first_right_block1_text_bottom2">
                                    <i class="fi-chat-circle mt-n1 me-1 fs-sm align-middle opacity-70"></i>
                                    2 comments
                                </div>
                    ...
                    <div class="first_right_block2">
                        <div class="first_right_block2_image">
                            <img src="./image/th02.jpg" alt="th02">
                        </div>
                        <div class="first_right_block2_text">
                            <div class="first_right_block2_text_top">TIPS & ADVICE</div>
                            <div class="first_right_block2_text_name">Top 10 Ways to Refresh Your Space</div>
                            <div class="first_right_block2_text_desc">Volutpat, orci, vitae arcu feugiat vestibulum
                                ultricies nisi, aenean eget. Vitae enim, tellus tempor consequat mi vitae...</div>
                            <div class="first_right_block2_text_bottom">
                                <div class="first_right_block2_text_bottom1">
                                    <i class="fi-calendar mt-n1 me-1 fs-sm align-middle opacity-70"></i>
                                    Nov 23
                                </div>
                                <div class="first_right_block2_text_bottom2">
                                    <i class="fi-chat-circle mt-n1 me-1 fs-sm align-middle opacity-70"></i>
                                    No comments
                                </div>
                            </div>
            ...
            <div class="dark_footer">
                <div class="dark_footer_block1">
                    <img src="./image/mobile.svg" alt="mobile">
                </div>
                <div class="dark_footer_block2">
                    <div class="dark_footer_block2_h1">Download Our App</div>
                    <div class="dark_footer_block2_h2">Find everything you need for buying, selling & renting property
                            in our new Finder App!</div>
                </div>
                <div class="dark_footer_block3">
                    <div class="dark_footer_block3_bl1">
                        <div class="dark_footer_block3_bl11">
