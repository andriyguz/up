    ...
    class Conndb{
        ...
        public function getShowTable($result){
            ...
            foreach($data as $elem) {
                ...
                $this->result.='<td>'.'<a href="/progect2/components/updateindex.php?id='.$elem['indexcity'].'">&#9998;</a>
                '.'</td>';
                $this->result.='<td>'.'<a href="/progect2/components/deleteindex.php?id='.$elem['indexcity'].'">&#10006;</a>
                '.'</td>';
                $this->result.='</tr>';
            }
            return $this->result;
        ...
        public function getUserInsert(){
            ...
            header('Location:http://up/progect2/indexprogect2.php');
        }
